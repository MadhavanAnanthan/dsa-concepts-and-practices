...
452 | Chapter 11: Batch Processing

<!-- PDF page 477 -->

system alone cannot do. ETL, as discussed in “Data Warehousing” on page 7, is an
example of this.
...
example, say you want to find the five most popular pages on your website. Y ou can
...
454 | Chapter 11: Batch Processing

<!-- PDF page 479 -->

Split each line into fields by whitespace, and output only the seventh field from
...
well [8].
Batch Processing with Unix Tools | 455
...
456 | Chapter 11: Batch Processing

<!-- PDF page 481 -->

Which approach is better? It depends on the number of URLs you have. For most
...
458 | Chapter 11: Batch Processing

<!-- PDF page 483 -->

Filesystems such as ext4 and XFS keep track of storage metadata including free space,
...
Batch Processing in Distributed Systems | 459
...
460 | Chapter 11: Batch Processing

<!-- PDF page 485 -->

s3://my-photo-bucket/2025/04/01 file to keep it present when all child objects are
deleted).
...
Batch Processing in Distributed Systems | 461
...
Orchestrators such as Kubernetes and Hadoop YARN (Y et Another Resource Nego‐
...
462 | Chapter 11: Batch Processing

<!-- PDF page 487 -->

Though each orchestrator uses different terminology, you will find these components
...
Batch Processing in Distributed Systems | 463

<!-- PDF page 488 -->

the problem is NP-hard, which means that it is prohibitively slow to calculate an
...
• Y ou might want to transfer data from one processing tool to another. For exam‐•
...
464 | Chapter 11: Batch Processing

<!-- PDF page 489 -->

process has read some data from the buffer before it can output more—a form
...
Batch Processing in Distributed Systems | 465

<!-- PDF page 490 -->

Since batch jobs regenerate their output from scratch every time they are run, task
...
1. Read a set of input files and break it into records. In the web server log example,1.
...
466 | Chapter 11: Batch Processing

<!-- PDF page 491 -->

columnar format, see “Column-Oriented Storage” on page 136) or Apache Avro
(a row-based format, see “ Avro” on page 172).
2. Call the mapper function to extract a key and value from each input record.2.
...
3. Sort all the key-value pairs by key. In the log example, this is done by the first3.
sort command.
4. Call the reducer function to iterate over the sorted key-value pairs. If there are4.
...
468 | Chapter 11: Batch Processing
...
Y ou can use dataflow engines to implement the same computations as MapReduce
...
470 | Chapter 11: Batch Processing

<!-- PDF page 495 -->

The output of the mapper consists of key-value pairs, and the framework needs to
...
as activity events or clickstream data), and on the right is a database of users. Y ou
...
Y ou can use the fact that in MapReduce, the shuffle brings together all the key-value
pairs with the same key to the same reducer, no matter which shard they were on
originally. Here, the user ID can serve as the key. Y ou can therefore write a mapper
...
472 | Chapter 11: Batch Processing
...
Batch Processing Models | 473

<!-- PDF page 498 -->

saw in “Cloud Data Warehouses” on page 135, query engines are responsible for
...
474 | Chapter 11: Batch Processing

<!-- PDF page 499 -->

Not all batch jobs are easily expressed in SQL, though, including iterative graph
...
476 | Chapter 11: Batch Processing

<!-- PDF page 501 -->

We’ve also seen that batch jobs are easy to troubleshoot and fix when things go awry.
...
478 | Chapter 11: Batch Processing

<!-- PDF page 503 -->

API, and Flink’s Gelly API [41], among others. It is also known as the Pregel model, as
...
480 | Chapter 11: Batch Processing
